...
# Modify the variable value so taht all of the 
...
five = {'happy':'birthday', 'finish':'chips', 'adding':'more'}
...
print 'five: {}'.format(five.get('finish') == 'chips')
print 'five: {}'.format(len(five) == 3)
print 'six:  {}'.format(len(six & {2, 5, 7}) == 2)
print 'seven:{}'.format(seven == 'Web')
